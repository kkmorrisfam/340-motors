...
-- Week 2 video of deleting and recreating database on render.com https://youtu.be/fokyvvlBfLA


--Week 6 Project add tables
...
--Create relationship between 'review' and 'inventory' tables (one inventory, many reviews)
...
--Create relationship between 'review' and 'account' tables (one account, many reviews)
ALTER TABLE IF EXISTS public.review
